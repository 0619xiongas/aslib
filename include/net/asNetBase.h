...
int StartListen(SOCKET& sock, const char* ip, unsigned short port,sockaddr_in* addr = nullptr);
int ConnectToServer(const char* ip, unsigned short port, SOCKET& sock, sockaddr_in* addr = nullptr);
